package com.travis.library.network;

import com.jakewharton.retrofit2.adapter.rxjava2.RxJava2CallAdapterFactory;
import com.travis.library.network.callback.DownloadCallback;
import com.travis.library.network.callback.RequestCallback;
import com.travis.library.network.callback.UploadCallback;
import com.travis.library.network.file.FileOperationService;
import com.travis.library.network.interceptor.ProgressResponseInterceptor;
import com.travis.library.network.progress.ProgressRequestBody;
import com.travis.library.util.FileUtils;
import com.travis.library.util.RxPlugin;
