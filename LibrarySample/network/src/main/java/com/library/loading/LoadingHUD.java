...
package com.travis.library.loading;
...
public class LoadingHUD {
    ...
    public LoadingHUD(Context context) {
        ...
        mWindowColor = context.getResources().getColor(R.color.loading_hud_default_color);
        mAnimateSpeed = 1;
        mCornerRadius = 10;
        mIsAutoDismiss = true;
     ...
     */
    public static LoadingHUD create(Context context) {
        return new LoadingHUD(context);
    }

  /**
   * Create a new HUD. specify the HUD style (if you use a custom view, you need {@code LoadingHUD.create(Context context)}).
   *
   * @param context Activity context that the HUD bound to
   * @param style One of the LoadingHUD.Style values
   * @return An unique HUD instance
   */
    public static LoadingHUD create(Context context, Style style) {
        return new LoadingHUD(context).setStyle(style);
    }
     ...
     * @return Current HUD
     */
    public LoadingHUD setStyle(Style style) {
        View view = null;
        switch (style) {
     ...
     * @return Current HUD
     */
    public LoadingHUD setDimAmount(float dimAmount) {
     ...
     * @return Current HUD
     */
    public LoadingHUD setSize(int width, int height) {
     ...
     * @return Current HUD
     */
    public LoadingHUD setWindowColor(int color) {
        mWindowColor = color;
        return this;
    }
     ...
     * @return Current HUD
     */
    public LoadingHUD setCornerRadius(float radius) {
     ...
     * @return Current HUD
     */
    public LoadingHUD setAnimationSpeed(int scale) {
        mAnimateSpeed = scale;
        return this;
    }
     ...
     * @return Current HUD
     */
    public LoadingHUD setLabel(String label) {
     ...
     * @return Current HUD
     */
    public LoadingHUD setDetailsLabel(String detailsLabel) {
     ...
     * @return Current HUD
     */
    public LoadingHUD setMaxProgress(int maxProgress) {
     ...
     * @return Current HUD
     */
    public LoadingHUD setCustomView(View view) {
        if (view != null) {
            mProgressDialog.setView(view);
        } else {
     ...
     * @return Current HUD
     */
    public LoadingHUD setCancellable(boolean isCancellable) {
     ...
     * @return Current HUD
     */
    public LoadingHUD setAutoDismiss(boolean isAutoDismiss) {
        mIsAutoDismiss = isAutoDismiss;
        return this;
    }

    public LoadingHUD show() {
        if (!isShowing()) {
            try {
    ...
    private class ProgressDialog extends Dialog {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.loading_hud);
